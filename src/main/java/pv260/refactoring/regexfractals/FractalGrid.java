...
public class FractalGrid {
	...
	public FractalGrid(int gridSide, double limit) {
		...
		signaturesArray = new String[gridSide][gridSide];
	...
	private static class QuadrantSlice {
		 ...
		 */
		private void writeLeavesTo(String[][] signaturesArray) {
			if (isLeaf) {
				signaturesArray[accumulatedX][accumulatedY] = accumulatedSignature;
			} else {
